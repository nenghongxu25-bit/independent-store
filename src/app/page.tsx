    ...
    <main style={{ 
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          position: 'relative',
          // 叠加闪烁动画 (diamondSparkle)，2秒一轮，不规则闪烁
          animation: 'diamondSparkle 2s ease-in-out infinite', 
        }}>
          <h1 style={{ 
            fontSize: '8.5rem', // 稍微放大，更有视觉冲击力
            fontStyle: 'italic',
        ...
        <h2 style={{ 
          fontSize: '1.05rem', 
          letterSpacing: '12px', // 进一步拉开字距，更显高级
          color: '#333',
          marginTop: '5px',
          fontWeight: '300',
          textTransform: 'uppercase'
